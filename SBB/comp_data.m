...
%                     elements equal to dx. The calculations here are
%                     probably necessary for previous versions              [?]
...
%        for a previous version and perharps they can be removed [s!]
...
while x <= Ltubo & c < length(gmis)                                         % [s!] In all the conditions below, substitute & with &&
	c = c+1;
	x = gmis(c);
