...
%                               Perry's law)
%                    cstPol:    (T_0 * P_0)^((1-kpolSA)/kpolSA)             [?]
...
%                    ptarget:   limit for charging curve (used for
%                               releasing) [Pa]                             [?]
...
%                    ptarget:   Target pressure to control function 
%                               discharge                                   [?]
...
while t - tfin < -1e-9
    ...
    delta0 = 1e-3; 
    % delta 0 is another advanced parameter that can be put in input. The
