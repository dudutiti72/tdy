...
% FRESNELCS This function calculates the fresnel cosine and sine integrals
% 
% INPUT     y:        Values for which fresnel integrals are evaluated
% 
% OUTPUTS   FresnelC: Fresnel cosine integral of y
...
for j = 1:length(y)
    ...
    if ( x < 1.0 )
        ...
        twofn = 0.0; fact = 1.0; denterm = 1.0; numterm = 1.0; sum = 1.0; 
        ratio = 10.0;
...
FresnelC = FresnelC .* signy;
FresnelS = FresnelS .* signy;
