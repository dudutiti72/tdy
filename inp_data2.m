function [CA,CVactv,D1,DBVdata,Dcoll,dLC,Dpy,dTF,dx,epsilon,fsl,gmis,gmisCF,iDCVa,kcoll,Lcoll,...
          Lvago,nomefilese,nomepath,P1,pCF,posDBV,SA,SR,t0,t95p,train,Tsim,tvis,typeDBV,Vbc,VhcM,...
          VhcMa,vManovra] = inp_data2(namedirfile,dynamic,fsl,nveicoli,train)
