...
% Rv is the vertical radius (used when two stretches have different slopes)

% N is the slope in per mil
N = N/1000; % [‰] (ALT+0137)

% teta is the rail roll angle [rad], teta_0 is the difference in centimeters
% among the inner and the outer rail
% scartamento is the gauge in meters
teta = asin(teta_0'/(scartamento*100))'; 

% ttratto provides informations on the type of stretch: 1 strainght;
% 2 full curve; 3 variable curve radius (parabolic)
